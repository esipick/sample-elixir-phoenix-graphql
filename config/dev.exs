...
config :grapgql, GrapgqlWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "vIyrhuv3o/+WEn7+vW9jDRcdnMmA4uiiZjHQSA9S9m7w6gesvbL7zZPAxwiEQ75v",
  watchers: [
...
config :grapgql, GrapgqlWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/grapgql_web/(live|views)/.*(ex)$",
      ~r"lib/grapgql_web/templates/.*(eex)$"
    ]
  ]
